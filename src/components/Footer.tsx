  ...
  return (
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://api.whatsapp.com/send?phone=5513997907864" aria-label="WhatsApp" className="text-gray-400 hover:text-white" target='_blank'>
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-center md:justify-between items-center md:items-end">
          <div className="flex flex-col items-center gap-2">
            <a href={copyrightUrl}>
                <img
                    src="https://raw.githubusercontent.com/andresinho20049/andresinho20049/refs/heads/main/public/Logo.png"
                    width={48}
                    height={48}
...
const LinkCopyright = ({
    ...
    <a
        href={href}
        className="text-sm text-center text-gray-500 hover:text-cyan-700 no-underline hover:underline decoration-cyan-700"
    >
        {children}
    </a>
);
