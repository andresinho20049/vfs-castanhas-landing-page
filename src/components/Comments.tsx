...
const initialComments: Comment[] = [
  ...
  },
  {
    ...
    content: 'O pagode aos domingos é *imperdível*. Venho com minha família toda semana!\n\n* Atendimento excelente\n* Comida deliciosa\n* Vista maravilhosa',
...
const renderMarkdown = (text: string) => {
  ...
  rendered = rendered.replace(/<li>/g, '<ul><li>').replace(/<\/li>\s*<ul>/g, '<ul>');
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Veja o que nossos clientes estão dizendo sobre nós. Se você já nos visitou, compartilhe sua experiência!
          </p>
        </div>
        ...
        {route == "authenticated" ? (
          ...
          <div className="max-w-3xl mx-auto mb-12 bg-white p-6 rounded-lg shadow-sm text-center">
            <p className="text-gray-600 mb-4">Faça login para deixar seu comentário</p>
            <Button 
